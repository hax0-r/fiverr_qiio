        ...
        <div class="transition-all duration-500 overflow-hidden absolute top-[6rem] w-full z-40 bg-white"
            ...
            <div x-ref="tab" class="max-w-7xl p-5 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-6 w-full mx-auto">
                ...
                <div class="w-full text-gray-800">
                    ...
                    <ul class="mt-2 list-disc space-y-2 pl-5">
                        <li><a href="/news-events.html" class="font-medium transition-all duration-500 hover:text-[#4285f4]">News &
                                Events
                            </a></li>
                        <li><a href="/press-releases.html" class="font-medium transition-all duration-500 hover:text-[#4285f4]">Press
                                Releases
                            </a></li>
                        <li><a href="/media-coverage.html" class="font-medium transition-all duration-500 hover:text-[#4285f4]">Media
                                Coverage
                            </a></li>
                    </ul>
                    <a href="/who-we-are.html" class="font-medium transition-all duration-500 hover:text-[#4285f4] block mt-3">Who we
                        are
                    </a>
                    <a href="/vision-values.html" class="font-medium transition-all duration-500 hover:text-[#4285f4] block mt-3">Vision &
                        Values

                    </a>
                    <a href="/team.html" class="font-medium transition-all duration-500 hover:text-[#4285f4] block mt-3">Team
                    </a>
                    <a href="/careers.html" class="font-medium transition-all duration-500 hover:text-[#4285f4] block mt-3">Careers
                    </a>
                    <a href="/social-responsibility.html" class="font-medium transition-all duration-500 hover:text-[#4285f4] block mt-3">Social
                        Responsibility
                    </a>
                    <a href="/security.html" class="font-medium transition-all duration-500 hover:text-[#4285f4] block mt-3">Security
                    </a>
                    <ul class="mt-2 list-disc space-y-2 pl-5">
                        ...
                        <li><a href="/vulnerability-report.html" class="font-medium transition-all duration-500 hover:text-[#4285f4]">Report
                                Vulnerability
                            </a></li>
                    </ul>
                    <a href="/contact.html" class="font-medium transition-all duration-500 hover:text-[#4285f4] block mt-3">Contact
                    </a>
                </div>
